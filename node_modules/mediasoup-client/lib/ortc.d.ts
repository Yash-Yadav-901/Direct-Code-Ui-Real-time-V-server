 ...
 */
export declare function canSend(kind: MediaKind, extendedRtpCapabilities: ExtendedRtpCapabilities): boolean;
/**
 * Whether the given RTP parameters can be received with the given RTP
 * capabilities.
 */
export declare function canReceive(rtpParameters: RtpParameters, extendedRtpCapabilities: ExtendedRtpCapabilities): boolean;
