...
class ReactNative106 extends HandlerInterface_1.HandlerInterface {
    // Closed flag.
    _closed = false;
    // Handler direction.
    _direction;
    ...
    constructor({ direction, iceParameters, iceCandidates, dtlsParameters, sctpParameters, iceServers, iceTransportPolicy, additionalSettings, extendedRtpCapabilities, }) {
        super();
