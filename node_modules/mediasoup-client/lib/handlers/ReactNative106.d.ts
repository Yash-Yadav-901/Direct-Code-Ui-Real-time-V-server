...
import { type HandlerFactory, HandlerInterface, type HandlerSendOptions, type HandlerSendResult, type HandlerReceiveOptions, type HandlerReceiveResult, type HandlerSendDataChannelOptions, type HandlerSendDataChannelResult, type HandlerReceiveDataChannelOptions, type HandlerReceiveDataChannelResult } from './HandlerInterface';
export declare class ReactNative106 extends HandlerInterface {
    private _closed;
    private _direction;
    private _remoteSdp;
